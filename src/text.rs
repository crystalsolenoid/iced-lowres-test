...
use iced_wgpu::graphics::cache;
use iced_wgpu::graphics::color;
use iced_wgpu::graphics::text::cache::{self as text_cache, Cache as BufferCache};
use iced_wgpu::graphics::text::{font_system, to_color, Editor, Paragraph};
use iced_wgpu::wgpu;
...
impl Pipeline {
    pub fn new(device: &wgpu::Device, queue: &wgpu::Queue, format: wgpu::TextureFormat) -> Self {
        ...
        let atlas = glyphon::TextAtlas::with_color_mode(device, queue, &state, format, COLOR_MODE);
        ...
        .filter_map(|(section, allocation)| {
            let (
                ...
                Text::Paragraph {
                    ...
                    use iced_wgpu::core::text::Paragraph as _;
                ...
                Text::Editor {
                    ...
                    use iced_wgpu::core::text::Editor as _;
